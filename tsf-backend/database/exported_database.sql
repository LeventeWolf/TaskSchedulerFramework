...
VALUES (1, 'https://github.com/soldair/node-floody/', '2a150c5552b8ce2f2a12ae4a3fd33882d5827afd', 'Tape', 'Yes', 39.16,
       ...
       (0, 'https://github.com/macacajs/macaca-chromedriver/', '7b125caf80f28fe56765cbbaf88447e87cf03e91', 'Mocha',
        'Yes', 12.9, 22, 3, 40, 38, 'lib/**, test/**', 'acg dies: .git/hooks/pre-commit\' Fix: remove pre-commit folder | Merge last two results', NULL),
...
(0, 'https://github.com/indutny/node-ip/', '5de805a25d3dc1bd1f5b9d781d80e0a9d7682f5d', 'Mocha', 'Yes', 11.8, 31, 33, 26, 27, 'test/*.js, lib/**', NULL, NULL),
...
(0, 'https://github.com/hapijs/hapi/', '1ad65ba793377928aa5a2dfc819888c5c9793394', 'Lab', 'Yes', 39124, 573, 443, 289, 306, 'lib/index.js', 'og: 496/785 tests failed | inject: 541 of 785 tests failed', NULL),
(0, 'https://github.com/hapijs/nes/', '71e9232bb84ad30ab0a5f62647b07144d44e2930', 'Lab', 'Yes', 500, 484, 199, 191, 139, 'lib/index.js, test/index.js', 'og: 100 pass | Run standard --fix before npm test', NULL),
...
(0, 'https://github.com/gentooboontoo/js-quantities/', 'b42d087b96e1ff2c24cff801f3ab16950c0d3c76', 'Jasmine', 'Yes', 7600.1, 31326, 202, 3730, 100, 'bench/**, bin/**, build/**, lib/**, spec/**', 'og: 126 tests, 445 assertions, 0 failures, 0 skipped | inject: 126 ok | acg heap out of memory', NULL),
...
(0, 'https://github.com/brisket/brisket/', '4564824f2797fc4f738978cf609af61f1e3b90b6', 'Jasmine', 'Not even', NULL, NULL, NULL, NULL, NULL, 'lib/**', 'npm test fails : Error: Could not locate the bindings file.', NULL),
...
(0, 'https://github.com/airbrake/node-airbrake/', '210a045148fe5ccd0198757e71ee0563813f8a31', 'sinon', 'Not even', NULL, NULL, NULL, NULL, NULL, 'index.js, lib/**', 'TypeError: os.tmpDir is not a function | Fix: node > 12 | -> Error: Got an invalid response from Node Security', NULL),
...
(0, 'https://github.com/digitalbazaar/forge/', 'fb2467d75e4bb092bd33e15c143a7d2856d1da13', '<no unit testing framework>', '-', NULL, NULL, NULL, NULL, NULL, 'lib/**', NULL, NULL),
...
(0, 'https://github.com/microsoft/ChakraCore/', 'd969210010802d2c23f2231e1fedd3ad6aa78db3', 'Saját', NULL, NULL, NULL, NULL, NULL, NULL, 'lib/**', 'Need cxx and cc path', NULL),
